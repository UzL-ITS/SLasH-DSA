...
pub use crate::page_inject::{BuddyPageInjector, InjectionConfig, PageInjector};
...
/// The VictimOrchestrator trait. A victim must implement this trait to be used as a target for the hammer attack.
///
